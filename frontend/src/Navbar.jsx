...
import mlogo from "./assets/samarcana-logo.png";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button onClick={() => scrollToSection("master")}className="px-4 py-2 border border-transparent border rounded hover:border-green-700 transition duration-300">Master & Tower Plans</button>
        ...
        <a
          href="callto:+918977516130"
          className="blinking-button px-4 py-2 text-white rounded-full shadow-md hover:opacity-50 transition duration-250 bg-[#fea611]"
        >
        Call +91-8977516130
      </a>
      ...
      {isMobileMenuOpen && (
        <div className="fixed top-16 left-0 w-full bg-white shadow-md md:hidden flex flex-col items-center space-y-4 py-4">
          ...
          <a
          href="callto:+918977516130"
          className="blinking-button px-4 py-2 text-white rounded-full shadow-md hover:opacity-50 transition duration-300 bg-[#fea611]"
        >
            Call +91-8977516130
          </a>
